...
function checkCollision(rock) {
  ...
  if (top > 360) { /*At this point rock is at the bottom of window */
...
function endGame() {
  ...
  var el = document.querySelectorAll(".rock");
...
function moveDodger(e) {
   ...
   */
   ...
   document.addEventListener('keydown', function(e){
     if(e.which === RIGHT_ARROW && e.stopPropagation){
       e.stopPropagation();
       moveDodgerRight();
     }
...
function moveDodgerRight() {
   ...
   */
   var dodgerRightEdge = positionToInteger(DODGER.style.left) + 40;
      ...
      //MOVE right changing dodger.style.left
   function step(){
     //DODGER.style.left = `${DODGER.style.left += 4}px`;
